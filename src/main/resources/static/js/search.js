import {pageUpEventHandler, beforePageBtnHandler}  from "/js/myPage_modules.js";
import {ioCallback_search, addNewSearchReviewContent, loadFirstItems, reviewClickedEventHandler} from "/js/myPage_load10Review.js";
...
const io = new IntersectionObserver(ioCallback_search, {threshold : 0.7});
window.addEventListener('load', () => {
    $review_container.innerHTML = ""; // 처음에 모두 삭제
    loadFirstItems(io, addNewSearchReviewContent);
})
